(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e={},t=t=>{let n=e[t.type];if(n){for(let[e,r]of Object.entries(n))if(t.target.closest(e))try{r(t)}catch(t){console.error(`이벤트 핸들러 실행 오류 (${e}):`,t)}}};const n=(()=>{let n=!1;return()=>{n||=(Object.keys(e).forEach(e=>{document.body.addEventListener(e,t)}),!0)}})(),r=(t,n,r)=>{e[t]||(e[t]={}),e[t][n]=r},i=(e=200)=>{let t=window.pageYOffset||document.documentElement.scrollTop,n=window.innerHeight,r=document.documentElement.scrollHeight;return t+n>=r-e},a=e=>{let t=!1;return(...n)=>{t||(t=!0,queueMicrotask(()=>{t=!1,e(...n)}))}},o={SET_PRODUCTS:`products/setProducts`,ADD_PRODUCTS:`products/addProducts`,SET_LOADING:`products/setLoading`,SET_ERROR:`products/setError`,SET_CATEGORIES:`products/setCategories`,SET_CURRENT_PRODUCT:`products/setCurrentProduct`,SET_RELATED_PRODUCTS:`products/setRelatedProducts`,RESET_FILTERS:`products/resetFilters`,SETUP:`products/setup`,SET_STATUS:`products/setStatus`},s={ADD_ITEM:`cart/addItem`,REMOVE_ITEM:`cart/removeItem`,UPDATE_QUANTITY:`cart/updateQuantity`,CLEAR_CART:`cart/clearCart`,TOGGLE_SELECT:`cart/toggleSelect`,SELECT_ALL:`cart/selectAll`,DESELECT_ALL:`cart/deselectAll`,REMOVE_SELECTED:`cart/removeSelected`,LOAD_FROM_STORAGE:`cart/loadFromStorage`,SYNC_TO_STORAGE:`cart/syncToStorage`},c={OPEN_CART_MODAL:`ui/openCartModal`,CLOSE_CART_MODAL:`ui/closeCartModal`,SET_GLOBAL_LOADING:`ui/setGlobalLoading`,SHOW_TOAST:`ui/showToast`,HIDE_TOAST:`ui/hideToast`},l=()=>{let e=new Set;return{subscribe:t=>e.add(t),notify:()=>e.forEach(e=>e())}},u=(e,t)=>{let{subscribe:n,notify:r}=l(),i=t;return{getState:()=>i,dispatch:t=>{let n=e(i,t);n!==i&&(i=n,r())},subscribe:n}};var d={getItem:()=>null,setItem:()=>{},removeItem:()=>{}};const f=(e,t=typeof window<`u`?window.localStorage:d)=>({get:()=>{try{let n=t.getItem(e);return n?JSON.parse(n):null}catch(t){return console.error(`Error parsing storage item for key "${e}":`,t),null}},set:n=>{try{t.setItem(e,JSON.stringify(n))}catch(t){console.error(`Error setting storage item for key "${e}":`,t)}},reset:()=>{try{t.removeItem(e)}catch(t){console.error(`Error removing storage item for key "${e}":`,t)}}});var p=class{#e;#t;#n;constructor(e=``){this.#e=new Map,this.#t=null,this.#n=e.replace(/\/$/,``)}get baseUrl(){return this.#n}get params(){return this.#t?.params??{}}get route(){return this.#t}get target(){return this.#t?.handler}addRoute(e,t){let n=[],r=e.replace(/:\w+/g,e=>(n.push(e.slice(1)),`([^/]+)`)).replace(/\//g,`\\/`),i=RegExp(`^${this.#n}${r}$`);this.#e.set(e,{regex:i,paramNames:n,handler:t})}findRoute(e){let t;try{t=new URL(e,`http://localhost`).pathname}catch{t=e.split(`?`)[0]}for(let[e,n]of this.#e){let r=t.match(n.regex);if(r){let t={};return n.paramNames.forEach((e,n)=>{t[e]=r[n+1]}),{...n,params:t,path:e}}}return null}_setRoute(e){this.#t=e}static parseQuery(e=``){let t=new URLSearchParams(e),n={};for(let[e,r]of t)n[e]=r;return n}static stringifyQuery(e){let t=new URLSearchParams;for(let[n,r]of Object.entries(e))r!=null&&r!==``&&t.set(n,String(r));return t.toString()}},m=class e extends p{#e;constructor(e=``){super(e),this.#e=l(),window.addEventListener(`popstate`,()=>{this._setRoute(this.findRoute(window.location.pathname)),this.#e.notify()}),document.addEventListener(`click`,e=>{let t=e.target;if(!t?.closest(`[data-link]`))return;e.preventDefault();let n=t.getAttribute(`href`)??t.closest(`[data-link]`)?.getAttribute(`href`);n&&this.push(n)})}get query(){return e.parseQuery(window.location.search)}set query(e){let t=this.#t(e);this.push(t)}subscribe(e){return this.#e.subscribe(e)}push(e){try{let t=e.startsWith(this.baseUrl)?e:this.baseUrl+(e.startsWith(`/`)?e:`/`+e);`${window.location.pathname}${window.location.search}`!==t&&window.history.pushState(null,``,t),this._setRoute(this.findRoute(t)),this.#e.notify()}catch(e){console.error(`라우터 네비게이션 오류:`,e)}}start(){this._setRoute(this.findRoute(window.location.pathname)),this.#e.notify()}#t(t){let n={...e.parseQuery(window.location.search),...t};Object.keys(n).forEach(e=>{(n[e]===null||n[e]===void 0||n[e]===``)&&delete n[e]});let r=e.stringifyQuery(n);return`${this.baseUrl}${window.location.pathname.replace(this.baseUrl,``)}${r?`?${r}`:``}`}static getUrl(t,n=``){let r={...e.parseQuery(window.location.search),...t};Object.keys(r).forEach(e=>{(r[e]===null||r[e]===void 0||r[e]===``)&&delete r[e]});let i=e.stringifyQuery(r);return`${n}${window.location.pathname.replace(n,``)}${i?`?${i}`:``}`}};const h={products:[],totalCount:0,currentProduct:null,relatedProducts:[],loading:!0,error:null,status:`idle`,categories:{}},g=u((e,t)=>{switch(t.type){case o.SET_STATUS:return{...e,status:t.payload};case o.SET_CATEGORIES:return{...e,categories:t.payload,loading:!1,error:null,status:`done`};case o.SET_PRODUCTS:return{...e,products:t.payload.products,totalCount:t.payload.totalCount,loading:!1,error:null,status:`done`};case o.ADD_PRODUCTS:return{...e,products:[...e.products,...t.payload.products],totalCount:t.payload.totalCount,loading:!1,error:null,status:`done`};case o.SET_LOADING:return{...e,loading:t.payload};case o.SET_ERROR:return{...e,error:t.payload,loading:!1,status:`done`};case o.SET_CURRENT_PRODUCT:return{...e,currentProduct:t.payload,loading:!1,error:null,status:`done`};case o.SET_RELATED_PRODUCTS:return{...e,relatedProducts:t.payload,status:`done`};case o.SETUP:return{...e,...t.payload};default:return e}},h),_=f(`shopping_cart`);var v={items:[],selectedAll:!1},ee=(e,t)=>e.find(e=>e.id===t);const y=u((e,t)=>{let n=_.get()??v;switch(t.type){case s.ADD_ITEM:{let{product:e,quantity:r=1}=t.payload;if(ee(n.items,e.productId))return{...n,items:n.items.map(t=>t.id===e.productId?{...t,quantity:t.quantity+r}:t)};{let t={id:e.productId,title:e.title,image:e.image,price:parseInt(e.lprice),quantity:r,selected:!1};return{...n,items:[...n.items,t]}}}case s.REMOVE_ITEM:return{...n,items:n.items.filter(e=>e.id!==t.payload)};case s.UPDATE_QUANTITY:{let{productId:e,quantity:r}=t.payload;return{...n,items:n.items.map(t=>t.id===e?{...t,quantity:Math.max(1,r)}:t)}}case s.CLEAR_CART:return{...n,items:[],selectedAll:!1};case s.TOGGLE_SELECT:{let e=t.payload,r=n.items.map(t=>t.id===e?{...t,selected:!t.selected}:t),i=r.length>0&&r.every(e=>e.selected);return{...n,items:r,selectedAll:i}}case s.SELECT_ALL:{let e=n.items.map(e=>({...e,selected:!0}));return{...n,items:e,selectedAll:!0}}case s.DESELECT_ALL:{let e=n.items.map(e=>({...e,selected:!1}));return{...n,items:e,selectedAll:!1}}case s.REMOVE_SELECTED:return{...n,items:n.items.filter(e=>!e.selected),selectedAll:!1};case s.LOAD_FROM_STORAGE:return{...n,...t.payload};default:return n}},v),b=u((e,t)=>{switch(t.type){case c.OPEN_CART_MODAL:return{...e,cartModal:{isOpen:!0}};case c.CLOSE_CART_MODAL:return{...e,cartModal:{isOpen:!1}};case c.HIDE_TOAST:return{...e,toast:{...e.toast,isVisible:!1}};case c.SHOW_TOAST:return{...e,toast:{isVisible:!0,message:t.payload.message,type:t.payload.type||`info`}};default:return e}},{cartModal:{isOpen:!1},globalLoading:!1,toast:{isVisible:!1,message:``,type:`info`}}),x=`/front_7th_chapter4-1/vanilla/`,S=new m(x);var C=new WeakMap,w={current:null,previous:null},T={mount:null,unmount:null,watches:[],deps:[],mounted:!1},E=e=>(C.has(e)||C.set(e,{...T}),C.get(e)),D=(e,t)=>!Array.isArray(e)||!Array.isArray(t)?!1:e.length===t.length?e.some((e,n)=>e!==t[n]):!0,O=e=>{let t=E(e);t.mounted||(t.mount?.(),t.mounted=!0,t.deps=[])},k=e=>{let t=E(e);t.mounted&&=(t.unmount?.(),!1)};const A=({onMount:e,onUnmount:t,watches:n}={},r)=>{let i=E(r);return typeof e==`function`&&(i.mount=e),typeof t==`function`&&(i.unmount=t),Array.isArray(n)&&(i.watches=typeof n[0]==`function`?[n]:n),(...e)=>{let t=w.current!==r;return w.current&&t&&k(w.current),w.previous=w.current,w.current=r,t?O(r):i.watches&&i.watches.forEach(([e,t],n)=>{let r=e();D(r,i.deps[n])&&t(),i.deps[n]=Array.isArray(r)?[...r]:[]}),r(...e)}};function j(e){let{productId:t,title:n,image:r,lprice:i,brand:a}=e;return`
  ...
  `},he=A({onMount:()=>{if(window.__INITIAL_DATA__){let e=window.__INITIAL_DATA__;console.log(`data ::`,e.pagination),g.dispatch({type:o.SETUP,payload:{products:e.products,categories:e.categories,totalCount:e.pagination.total,loading:!1,status:`done`}});return}P()},watches:[()=>{let{search:e,limit:t,sort:n,category1:r,category2:i}=S.query;return[e,t,n,r,i]},()=>F(!0)]},()=>{let e=g.getState(),{search:t,limit:n,sort:r,category1:i,category2:a}=S.query,{products:o,loading:s,error:c,totalCount:l,categories:u}=e,d={category1:i,category2:a},f=o.length<l;return X({headerLeft:`<h1 class="text-xl font-bold text-gray-900">
          <a href="/" data-link>쇼핑몰</a>
        </h1>`,children:`
        <!-- 검색 및 필터 -->
...
`;function ve({product:e,relatedProducts:t=[]}){let{productId:n,title:r,image:i,lprice:a,brand:o,description:s=``,rating:c=0,reviewCount:l=0,stock:u=100,category1:d,category2:f}=e,p=Number(a),m=[];return d&&m.push({name:d,category:`category1`,value:d}),f&&m.push({name:f,category:`category2`,value:f}),`
    ...
    `:``}
  `}const ye=A({onMount:()=>{V(S.params.id)},watches:[()=>[S.params.id],()=>V(S.params.id)]},()=>{let{currentProduct:e,relatedProducts:t=[],error:n,loading:r}=g.getState();return X({headerLeft:`<div class="flex items-center space-x-3">
          <button onclick="window.history.back()" 
        ...
        </div>`,children:r?ge:n&&!e?_e({error:n}):ve({product:e,relatedProducts:t})})});S.addRoute(`/`,he),S.addRoute(`/product/:id/`,ye),S.addRoute(`.*`,()=>X({headerLeft:le(),children:`<div class="text-center my-4 py-20 shadow-md p-6 bg-white rounded-lg">
